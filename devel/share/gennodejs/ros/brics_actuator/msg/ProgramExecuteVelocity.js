...
class ProgramExecuteVelocity {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ProgramExecuteVelocity(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ProgramExecuteVelocity(null);
...
module.exports = ProgramExecuteVelocity;
