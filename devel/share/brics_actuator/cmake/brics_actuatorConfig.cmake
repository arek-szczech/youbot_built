...
if("TRUE" STREQUAL "TRUE")
  set(brics_actuator_SOURCE_PREFIX /home/arek/youbot/src/youbot/brics_actuator)
  set(brics_actuator_DEVEL_PREFIX /home/arek/youbot/devel)
  ...
  set(brics_actuator_INSTALL_PREFIX /home/arek/youbot/install)
...
if(NOT "/home/arek/youbot/devel/include " STREQUAL " ")
  set(brics_actuator_INCLUDE_DIRS "")
  set(_include_dirs "/home/arek/youbot/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'brics_actuator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Walter Nowak <nowak@locomotec.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'brics_actuator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arek/youbot/src/youbot/brics_actuator/${idir}'.  Ask the maintainer 'Walter Nowak <nowak@locomotec.com>' to fix it.")
    endif()
